...
export default function Footer() {
  return (
    <footer className="footer items-center p-4 bg-black text-neutral-content">
      <aside className="items-center grid-flow-col text-lime-500">
        <p>Copyright © 2023 - All right reserved</p>
      </aside>
      <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
        <a href="https://www.youtube.com/@miyukinagara">
          <svg
        ...
        <a href="https://github.com/naagaraa">
          <svg
            className="h-8 w-8 fill-current"
            xmlns="http://www.w3.org/2000/svg"
            height="16"
        ...
        <a href="https://gitlab.com/naagaraa">
          <svg
            className="h-8 w-8 fill-current"
            xmlns="http://www.w3.org/2000/svg"
            height="16"
