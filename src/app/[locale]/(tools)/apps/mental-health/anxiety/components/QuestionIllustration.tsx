...
export const illustrations = [
  ...
  "https://img.freepik.com/free-vector/self-love-concept-illustration_114360-10902.jpg",
];
  ...
  return (
    <div className="flex justify-center items-center h-full p-4">
      <Image
        ...
        width={500} // atur width sesuai kebutuhan layout
        height={400} // atur height sesuai layout
        className="object-contain"
        priority={true} // opsional, untuk preload gambar penting
      />
    </div>
  );
}
